/**
 * Horizon Prototype — EA Sidenav Component
 * Registers the EA Workspace side navigation in window.HorizonComponents.
 * Edit this file to update the nav across all EA prototype files.
 * Include BEFORE interactions.js (no defer).
 */

window.HorizonComponents = window.HorizonComponents || {};

window.HorizonComponents['ea-sidenav'] = `
<nav class="sidenav sidenav--collapsed sidenav--dark" id="sidenav-main" aria-label="EA Workspace navigation">
  ...
  <div class="sidenav__top">
    <div class="sidenav__nav">
      ...
      <!-- Initiatives — expandable group -->
      <div class="sidenav__group">
        <button class="sidenav__item sidenav__group-toggle" title="Initiatives" aria-expanded="true">
          <span data-icon="rocketship"></span>
          <span class="sidenav__item__label">Initiatives</span>
          <span class="sidenav__group-chevron" data-icon="chevron-up"></span>
        </button>
        <ul class="sidenav__subnav">
          <li class="sidenav__subnav-item">Retire SharePoint Workflow</li>
          <li class="sidenav__subnav-item">FY26 Onboarding consolidation</li>
          <li class="sidenav__subnav-item">SQL Server 2016 remediation</li>
        </ul>
      </div>
